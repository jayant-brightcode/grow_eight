...
export const GetCourse = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const course = await courseModel.find({status:true})
...
export const getCourseById = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
          ...
          const find_cat = await courseModel.findOne({$and:[{_id:course_id},{status:true}]})
...
export const deleteCourse = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
           ...
           await courseModel.findByIdAndUpdate({_id:course_id},{status:false})
...
export const EditDocument = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            const name = req.body.name
            const doc_image = req.files
            const doc_desc = req.body.document_desc
            ...
            if(!doc_desc){
                return res.status(400).json({
                    message:"document desc not found"
                })
            }

            if(name && doc_desc &&  !doc_image || doc_image==null){

                 await requiredDocumentmodel.findByIdAndUpdate({_id:doc_id},{document_name:name,document_desc:doc_desc})
            ...
            if(doc_image!=null || doc_image && name && doc_desc){ 

                const randomname = Date.now() + '-'+doc_image.doc_image.name
              const newpath =  path.join(process.cwd(),'document_image',randomname)
              await doc_image.doc_image.mv(newpath)
         
       

            await requiredDocumentmodel.findByIdAndUpdate({_id:doc_id},{document_name:name,document_img:randomname,document_desc:doc_desc})
...
export const GetRequiredDocument = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const doc = await requiredDocumentmodel.find({status:true})
...
export const DeleteDocument = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
          ...
          await requiredDocumentmodel.findByIdAndUpdate({_id:doc_id},{status:false})
...
export const EditLanguage = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            const name = req.body.name
            const lang_image = req.files
            const lang_desc = req.body.desc
            ...
            if(!lang_desc){
                return res.status(400).json({
                    message:"lang desc not found"
                })
            }

            if(name && lang_desc &&  !lang_image || lang_image==null){

                 await languageModel.findByIdAndUpdate({_id:lang_id},{lang_name:name,lang_desc:lang_desc})
            ...
            if(lang_image!=null || lang_image && name && lang_desc){ 

                const randomname = Date.now() + '-'+lang_image.lang_image.name
              const newpath =  path.join(process.cwd(),'language_image',randomname)
              await lang_image.lang_image.mv(newpath)
          //    console.log(name)
       

            await languageModel.findByIdAndUpdate({_id:lang_id},{lang_name:name,lang_desc:lang_desc,lang_img:randomname})
...
export const DeleteLanguage = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            ...
            await languageModel.findByIdAndUpdate({_id:lang_id},{status:false})
...
export const GetLanguage = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const doc = await languageModel.find({status:true})
...
export const GetCountry = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const doc = await countryModel.find({status:true})
...
export const AddUniversity = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            let course = []
            if(course_uni==null || course_uni == undefined){
                course = []
            }else{
             course = JSON.parse(course_uni)
            ...
            let language_required = []

            if(req.body.required_documents==null || req.body.required_documents==undefined || req.body.required_documents==''){
                required_documents = []
            }else{
                required_documents = JSON.parse(req.body.required_documents) 
            }
            
            const application_guidance = req.body.application_guidance

            if(req.body.language_required==null || req.body.language_required ==undefined || req.body.language_required==''){
                language_required = []
            }else{
                console.log(req.body.language_required)
                 language_required = JSON.parse(req.body.language_required)
         ...
         if(!name){
            ...
            if(university_photo!=null || university_photo !=undefined){
                university_image = Date.now() + '-'+university_photo.name
                const newpath =  path.join(process.cwd(),'universityPhotos',university_image)
            ...
            if(galary !=null || galary !=undefined){
            ...
            if(required_documents!=null || required_documents!=undefined){
            ...
            if(language_required!=null || language_required !=undefined){
...
export const DeleteUniversity = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            await universityModel.findByIdAndUpdate({_id:university_id},{status:false})
...
export const EditUniverisity = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const u_id = req.body.university_id
         ...
         if(!name){
           ...
           if(!category){
            ...
            await universityModel.findByIdAndUpdate({_id:u_id},{name:name,
                address:address,
                introduction:introduction,
                university_image:university_image,
                course:CourseModel,
...
export const GetUniversity = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
          ...
          const university = await universityModel.find({status:true}).populate('course').populate('faculty').populate('facility').populate('required_document').populate('language_require').populate("galary").populate("category")
...
export const GetUniversityById = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
          ...
          const university = await universityModel.findOne({$and:[{_id:u_id},{status:true}]}).populate('course').populate('required_document').populate('language_require')
...
export const deleteCategory = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            ...
            await categoryModel.findByIdAndUpdate({_id:cat_id},{status:false})
...
export const deleteCountry = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            ...
            await countryModel.findByIdAndUpdate({_id:country_id},{status:false})
...
export const getCountryById = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
          ...
          const find_cat = await countryModel.findOne({$and:[{_id:country_id},{status:true}]})
...
export const getCategories = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
          ...
          const f_category = await categoryModel.find({status:true})
...
export const getRegion = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
          ...
          const f_region = await regionModel.find({status:true})
...
export const getRegion_by_id = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
          ...
          const f_region = await regionModel.findOne({$and:[{_id:regiond_id},{status:true}]})
...
export const deleteRegion = async(req,res)=>{
    try {
        ...
        if(token.admin_type == 1){
            ...
            await regionModel.findByIdAndUpdate({_id:regiond_id},{status:false})
...
export const GetAllAppliedApplication = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const apply = await applicationModel.find().populate('user').populate('university')
...
export const GetApplicationById = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
           ...
           const apply = await applicationModel.findOne({_id:application_id}).populate('user').populate('university')
            return res.status(201).json({
              application:apply
            })
...
export const EditCounselor = async(req,res)=>{
    ...
    try {
        ...
        if(token.admin_type == 1){
            ...
            const image = req.files.counselor_image
            const isactive = req.body.isActive
            const counsellor_id = req.body.counselor_id
            ...
            await userModel.findByIdAndUpdate({_id:counsellor_id},{
                phone:phone,
                name:name,
                email:email,
                profile_photo:randomname,
 ...
 export const AddFmgePassingRate = async(req,res)=>{
  ...
  export const GetCounselor = async(req,res)=>{
    ...
    try {
       ...
       const counselor = await userModel.findOne({$and:[{isActive:true},{user_type:3},{status:true}]})
